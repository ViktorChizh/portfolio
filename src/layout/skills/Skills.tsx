...
const skills: Skill[] = [
  ...
  { iconId: "js", progress: 70, title: "JavaScript" },
  { iconId: "ts", progress: 70, title: "TypeScript" },
  { iconId: "react", progress: 75, title: "React" },
  { iconId: "next", progress: 70, title: "NextJS" },
  { iconId: "vue", progress: 75, title: "VueJS" },
  ...
  { iconId: "tailwind", progress: 75, title: "TailWind" },
  { iconId: "StyledComponents", progress: 80, title: "Styled Com-ponents" },
